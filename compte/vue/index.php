...
<head>
    ...
    <link rel="stylesheet" href="../../style/compte.css?v=1.1">
</head>
...
<body>
    ...
    <div class="example-credentials">
        ...
        <ul>
            <li><strong>Identifiant :</strong> <span class="highlight">demo_user</span></li>
            <li><strong>Mot de passe :</strong> <span class="highlight">demo_password</span></li>
        </ul>
    </div>
</body>
